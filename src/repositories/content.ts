...
class RepositoryContent implements IRepositoryContent {
    ...
    async createContent(arg:ICreateContent): Promise<any>{
        console.log({
            data: {
                ...
                product_category : this.convertToPrismaProductCategory(arg.product_category),
                imges : arg.imges
            }
        })
    ...
    private convertToPrismaProductCategory(pc:ProductCategory):PrismaProductCategory {
        switch(pc){
